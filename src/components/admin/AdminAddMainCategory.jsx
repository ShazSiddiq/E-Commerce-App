...
export default function AdminAddMaincategory() {
    ...
    let { add, getMainCategory } = useContext(MainCategory)
                ...
                <div className="col-xl-10 col-lg-9 col-md-8 col-sm-6 col-12">
                    ...
                    <form onSubmit={postData}>
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" name='name' placeholder='Enter MainCategory Name' required onChange={getData} />
                        </div>
